...
void print(const string &content) {
    for(int i=0;i<content.size();i++){
        ...
        if(c == '$'){
            ...
            if(definedvar.find(varname) != definedvar.end()){
            ...
            } else if(definedposition.find(varname) != definedposition.end()){
                cout << definedposition[varname];
            } else if(varname == "InputLine"){
                string input;
                getline(cin, input);
                cout << input;
                ...
                cin >> input;
                cout << input;
            } else if(varname == "newline"){
                cout << endl;
            } else if(varname == "space"){
                cout << ' ';
            } else if(varname == "tab"){
                cout << '\t';
            } else if(varname == "null" || varname == "NULL")
            {
