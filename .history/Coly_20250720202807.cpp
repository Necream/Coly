                ...
                for(char c : content){
                    if(c=='$'){
                        ...
                        if(varnum==1){
                            ...
                            } else if(definedvar.find(varname)!=definedcode.end()){
                                var1=definedcode[varname];
                            }
                        }
                    }
...
int main(int argc, char *argv[]){
    if(argc > 2){
        for(int i = 2;i < argc;i++) agrumentlist.push_back(argv[i]);
    }
    if(argc==1){
