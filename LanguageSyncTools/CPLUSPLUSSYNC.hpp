...
vector<string> insertsynccode(vector<string> lines, const vector<var> syncvariables) {
    vector<string> newlines;
    newlines.push_back("#include <iostream>");
    newlines.push_back("#include <sstream>");
    newlines.push_back("#include <string>");
    newlines.push_back("template <class t1,class t2>");
    newlines.push_back("t2 t12t2_IADDTHISTOAVOIDTHESAMENAMEFUNCTION(t1 var){");
    newlines.push_back("    std::stringstream ss;");
    newlines.push_back("    ss << var;");
    newlines.push_back("    t2 result;");
    newlines.push_back("    ss >> result;");
    newlines.push_back("    return result;");
    newlines.push_back("}");
    for(string line:lines) newlines.push_back(line);
    return newlines;
}
